...
class Data:
    """
    * Data set and ARD% calculation.
    In this class the following methods are present:
        - data: contains all experimental data (Temperature, Pressure , experimental speed of sound)
        - ARD: calculation of Average Relative Deviation (ARD%)
    """
    def __int__(self):
        pass
    ...
    def data(set):
        ...
        #Composition of 0.9985 for H20 and 0.0015 for CO2
            ...
            T = np.array([273.18, 273.18, 273.20, 273.24, 273.23, 273.14, 273.18,
                          273.24, 273.23, 273.24, 273.24, 273.18, 273.17, 273.23,
                          273.20, 278.22, 278.23, 278.23, 278.24, 278.25, 278.25,
                          278.23, 278.26, 278.20, 278.22, 278.21, 278.22, 278.21,
                          278.21, 278.22, 283.19, 283.18, 283.16, 283.15, 283.20,
                          283.14, 283.13, 283.11, 283.09, 283.22, 283.17, 283.06,
                          283.09, 283.05, 283.07, 288.31, 288.27, 288.25, 288.29,
                          288.20, 288.25, 288.25, 288.18, 288.17, 288.13, 288.11,
                          288.10, 288.09, 288.09, 288.09, 288.09, 293.24, 293.24,
                          293.24, 293.24, 293.23, 293.25, 293.23, 293.23, 293.24,
                          293.24, 293.24, 293.25, 293.24, 293.25, 293.25, 298.26,
                          298.26, 298.26, 298.26, 298.26, 298.26, 298.24, 298.27,
                          298.24, 298.22, 298.23, 298.25, 298.23, 298.24, 298.24,
                          298.25, 303.24, 303.23, 303.23, 303.29, 303.23, 303.24,
                          303.24, 303.25, 303.25, 303.32, 303.29, 303.29, 303.27,
                          303.29, 303.28, 308.27, 308.28, 308.28, 308.27, 308.29,
                          308.29, 308.30, 308.28, 308.30, 308.27, 308.30, 308.25,
                          308.27, 308.31, 308.29, 313.30, 313.30, 313.30, 313.33,
                          313.29, 313.29, 313.31, 313.33, 313.30, 313.32, 313.30,
                          313.30, 313.33, 313.32, 313.33])

            P = 1e6*np.array([4.00, 6.00, 8.00, 9.98, 10.00, 15.00, 17.96, 19.98,
                              24.99, 29.93, 35.00, 40.00, 40.02, 44.97, 50.05,
                              3.99, 5.99, 7.99, 9.99, 12.00, 15.00, 19.99, 20.00,
                              25.02, 30.00, 35.00, 39.99, 40.01, 44.98, 49.94,
                              4.01, 6.00, 7.99, 9.99, 11.99, 15.00, 18.00, 20.00,
                              25.03, 29.99, 29.99, 35.04, 39.98, 45.00, 49.93,
                              4.00, 6.01, 7.99, 9.99, 12.01, 14.99, 18.00, 20.00,
                              20.01, 25.01, 30.02, 35.06, 40.01, 40.03, 45.00,
                              49.96, 4.01, 6.00, 8.00, 9.99, 11.99, 14.99, 18.00,
                              20.00, 25.02, 30.00, 35.01, 40.00, 40.01, 44.99,
                              50.00, 4.01, 6.01, 8.00, 10.00, 15.01, 18.01,
                              20.01, 19.99, 25.00, 29.99, 34.99, 35.00, 40.01,
                              40.00, 45.08, 49.96, 4.01, 6.01, 8.01, 10.00,
                              10.01, 14.97, 17.96, 20.03, 25.04, 30.00, 35.00,
                              40.00, 40.03, 44.98, 49.96, 4.01, 6.01, 8.01, 10.00,
                              9.97, 14.98, 17.96, 20.00, 25.01, 29.98, 30.01, 34.99,
                              39.99, 44.98, 49.94, 4.01, 6.01, 8.01, 9.99, 9.99,
                              15.00, 14.99, 19.99, 25.00, 29.99, 30.00, 34.99, 39.99,
                              44.99, 50.05])

            u_exp = np.array([1410.64, 1413.88, 1417.21, 1420.23, 1420.22, 1428.15,
                              1432.63, 1436.17, 1444.42, 1452.73, 1461.32, 1469.65,
                              1469.71, 1478.40, 1487.48, 1434.67, 1437.71, 1440.82,
                              1444.04, 1447.27, 1452.25, 1460.26, 1460.37, 1468.33,
                              1476.81, 1485.03, 1493.73, 1493.59, 1502.25, 1510.93,
                              1455.41, 1458.52, 1461.63, 1464.68, 1468.18, 1472.86,
                              1477.81, 1480.87, 1489.14, 1497.99, 1497.96, 1505.95,
                              1514.57, 1522.89, 1531.32, 1474.38, 1477.42, 1480.62,
                              1484.04, 1486.83, 1492.03, 1497.04, 1500.27, 1499.98,
                              1508.05, 1516.36, 1524.87, 1533.18, 1533.02, 1541.55,
                              1550.10, 1490.21, 1493.66, 1496.99, 1500.24, 1503.48,
                              1508.47, 1513.34, 1516.85, 1525.15, 1533.43, 1541.71,
                              1550.20, 1550.17, 1558.55, 1567.24, 1504.65, 1507.93,
                              1511.30, 1514.65, 1522.90, 1527.97, 1531.19, 1531.23,
                              1539.51, 1548.04, 1556.27, 1556.34, 1564.86, 1564.76,
                              1573.38, 1581.58, 1516.83, 1520.15, 1523.60, 1526.93,
                              1526.96, 1535.30, 1540.37, 1543.94, 1552.20, 1560.90,
                              1569.39, 1577.76, 1577.68, 1586.03, 1594.51, 1527.40,
                              1530.94, 1534.26, 1537.65, 1537.58, 1546.27, 1551.22,
                              1554.79, 1563.59, 1571.55, 1571.59, 1580.18, 1588.61,
                              1597.11, 1605.49, 1536.30, 1539.89, 1543.50, 1546.88,
                              1546.80, 1555.47, 1555.43, 1564.13, 1572.67, 1581.27,
                              1581.34, 1589.74, 1598.14, 1606.67, 1615.12])

        return T, P, u_exp


    @classmethod
    def ARD(cls, dataset=0, association=0):

        R, sigma, Ek, mi, Eabk, Kab, Kij, x, A, B, C, D, molar_mass, code, num_sites = Parameters().parameters(dataset)
        T, P, u_exp = cls.data(dataset)
        ...
        for i in range(len(T)):
            ite += 1
            u_calc[i] = SAFT.speed_of_sound(molar_mass, P[i], T[i], x, num_sites, code, association)
